...
import { styles } from '../HotelsList/HotelBookingConfirmation/wrapper/hotelBookingResStyle';
        ...
        <Page size="A4" style={{ paddingTop: 25, paddingBottom: 25, paddingLeft: 25, paddingRight: 25, }}>
            ...
            <View style={styles.head}>
                <View style={styles.PDFHead}>
                    ...
                    <Text style={styles.heading}>{InvoiceData.title}</Text>
                ...
                <View style={styles.PAXInfo}>
                    {
                        (!InvoiceData.cnic) ?
                            <>
                                ...
                                <Text style={styles.right}>Booking Status: {InvoiceData.bookingStatus}</Text>
                            </>
                            :
                            <>
                                <Text style={styles.left}>Customer: {InvoiceData.customer_name}</Text>
                                ...
                                <Text style={styles.left}>Booking Status: {InvoiceData.bookingStatus}</Text>
                            </>
                    }
                </View>
