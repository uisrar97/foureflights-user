...
export default function AirblueSegment({ segments, fare, cabin }) {
  cabin = "Economy";
  let BaggageInfo = {};
  let val = "";
  let unit = "";

  if (fare[0].FareInfo2.PassengerFare) {
    val =
      fare[0].FareInfo2.PassengerFare.FareBaggageAllowance
        .UnitOfMeasureQuantity;
    unit =
      fare[0].FareInfo2.PassengerFare.FareBaggageAllowance.UnitOfMeasure ===
      "KGS"
        ? "Kilograms"
        : fare.FareInfo2.PassengerFare.FareBaggageAllowance.UnitOfMeasure;
